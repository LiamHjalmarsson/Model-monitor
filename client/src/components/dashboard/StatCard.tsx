...
export default function StatCard({title, value, icon, colors = {}}: StatCardProps) {
	...
	return (
		...
		>
			<div className={`flex-shrink-0 w-12 h-12 rounded-full ${bg} ${text} flex items-center justify-center mr-4`}>
				{icon}
			</div>

			<div className="flex flex-col">
				<p className="text-xs font-medium uppercase text-dark-gary tracking-wide">{title}</p>
