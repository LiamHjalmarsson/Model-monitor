...
export function BrandCard({
	...
	return (
		<Link
			to={`/brands/${brand.id}`}
			className={`relative overflow-hidden bg-white p-lg rounded-xl shadow hover:shadow-lg transition-all duration-200 flex flex-col group border-l-4 ${borderClass} ${hoverBorderClass}`}
		>
